        ...
        <table class="email-content" width="100%" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td class="email-masthead">
              <a class="email-masthead_name brand">ChitChat</a>
            </td>
          </tr>
          <!-- Email Body -->
          <tr>
              ...
              <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td class="content-cell">
                    ...
                    <p>Once verified, you can start using all of ChitChat's features to explore, build, and share your idea.</p>
                    <p>Thanks,<br>Team Developer ChitChat</p>
                    <!-- Sub copy -->
            ...
            <td>
              <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-cell">
                    <p class="sub center">
                      <a class="email-masthead_name brand">ChitChat</a><br>
                      <br>Sent with &#x2764; By. Developer Team Webchat.
